        ...
        <form class="mx-10 my-20 w-full max-w-lg" method="POST" action="/saveInvoice">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
              <div class="w-full px-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password" name="name">
                  Tagihan milik:
                </label>
                <input name="nama" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Nama Pemilik Tagihan">
              </div>
            </div>
                ...
                <div class="md:flex md:items-center mb-6">
                  <div class="flex flex-wrap -mx-3 mb-3">
                      <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="nama_produk">
                          Nama Item
                        </label>
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="barang[0][nama_produk]" id="barang[0][nama_produk]" type="text" placeholder="Ex. OJP">
                      </div>
                      <div class="w-full md:w-1/2 px-3">
                        <label for="barang[0][harga_satuan]" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                          Biaya
                        </label>
                        <input for="barang[0][harga_satuan]" name="barang[0][harga_satuan]" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="harga_satuan" type="number" placeholder="Ex:1000000">
                      </div>
                    </div>
                  ...
                  <div class="md:w-2/3">
                    <button onclick="addItem()" class="shadow bg-blue-500 hover:bg-blue-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                      Tambah Barang
                    </button>
                  </div>
