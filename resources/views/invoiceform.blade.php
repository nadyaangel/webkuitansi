...
<body>
            ...
            <form class="mx-10 my-16 w-full max-w-lg" method="POST" action="/saveInvoice">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <textarea name="keterangan" rows="5" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" placeholder="Keterangan"></textarea>
                    </div>
                  </div>
                ...
                <div class="flex justify-center">
                    ...
                    <button
                        class="shadow mt-10 bg-blue-600 hover:bg-blue-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
    ...
    <script>
        ...
        function addItem() {
            ...
            namaProdukLabel.classList.add('block', 'uppercase', 'tracking-wide', 'text-gray-700', 'text-xs', 'font-bold',
                'mb-2');

            const namaProdukInput = document.createElement('input');
            namaProdukInput.type = 'text';
            namaProdukInput.placeholder = "Ex. OJP"
            namaProdukInput.classList.add('appearance-none', 'block', 'w-full', 'bg-gray-200', 'text-gray-700', 'border',
            ...
            hargaSatuanLabel.classList.add('block', 'uppercase', 'tracking-wide', 'text-gray-700', 'text-xs', 'font-bold',
                'mb-2');
            ...
            hargaSatuanInput.classList.add('appearance-none', 'block', 'w-full', 'bg-gray-200', 'text-gray-700', 'border',
